	...
	<div class="wrapper">
		<nav id="sidebar" class="sidebar js-sidebar">
          ...
          <span class="align-middle">AdminKit</span>
              ...
              <i class="align-middle" data-feather="target"></i> <span class="align-middle">Product</span>
            </a>
					</li>

					<li class="sidebar-item">
						<a class="sidebar-link" href="delivery_fee.php">
              <i class="align-middle" data-feather="dollar-sign"></i> <span class="align-middle">Delivery Fee</span>
            </a>
					</li>
					<li class="sidebar-item">
              ...
              <i class="align-middle" data-feather="bar-chart"></i> <span class="align-middle">Order</span>
            </a>
					</li>
				</ul>
			</div>
